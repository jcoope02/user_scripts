...
def main():
    ...
    token = get_token(client_id, client_secret, org_name, is_custom_instance, custom_base_url)
    print(f"\nUsing organization: {org_name}")

    users = fetch_users(token, org_name, is_custom_instance, custom_base_url)
